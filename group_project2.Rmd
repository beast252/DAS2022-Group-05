...
<<<<<<< HEAD
|  Model        |  link function| AIC| BIC |Pseudo-R² (Cragg-Uhler)|Pseudo-R² (McFadden)|
|:-----------------|----:|---:|----:|---:|----:|
|model1     | $g(p_i)=log(\frac{p_i}{1-p_i})$| 1310.07|  1367.45| 0.72|0.57|
|model2     | $g(p_i)=\phi^{-1}(pi),p_i=\phi(\frac{x_i-\mu}{\sigma})$ | 1334.66|1392.04|0.71|0.56|
|model3     | $g(p_i)=log[-log(1-p_i)]$ | 1404.55|1461.94|0.69|0.54|
...
>>>>>>> 7f314e4a72ae301d3e1c4b056c82ee02e152c6f2
```{r}
...
## Hosmer_Lemeshow goodness of fit test
```{r, echo=FALSE}
library(vcdExtra)
```
